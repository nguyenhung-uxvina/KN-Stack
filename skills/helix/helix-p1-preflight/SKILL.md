...
- `/helix-project-init` outputs in `Phase0-Plan/` (if available):
...
□ Product Planning document exists (from /helix-project-init)
□ ICD v0 exists (or N/A for single-domain)

PHASE-0 PLANNING OUTPUTS CHECK (Phase0-Plan/ folder):
