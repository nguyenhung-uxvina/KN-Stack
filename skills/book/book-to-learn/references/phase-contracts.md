...
| L4 | `framework_ung_vien` | `LEARN/learn/` (bài học, RETRIEVAL.md; S0 dùng lại notebook `btl-<slug>-goc`/`btl-<slug>-mo-rong`, không tạo mới), `LEARN/learn/feynman-<slugify(framework)>.md` | `learn-methodology`, `learn-practice`, `learn-track`; CEO tự gõ `/learn-teach` | `… L4` |
