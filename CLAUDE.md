...
```
KN-Stack/
├── skills/           ← 240 skills organized by domain (15 domains)
...
│   ├── mentors/      (56, dynamic) — Per-mentor advisor skills (add more via /mentor-board --add <leader>); orchestrator at galaxy/mentor-board/
