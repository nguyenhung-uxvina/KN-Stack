...
| `scan_sources` | `1_Projects/*/` (_Project_Brief.md, Status.md, Patent_Draft_*.md) · `2_Areas/HELIX*/` + design journal · RE report (reverse-engineering, reverse-mc) · `_meta/decisions.md` · FTO Record QP-02-06 · sản phẩm đã triển khai/đã bán/đã showcase |
