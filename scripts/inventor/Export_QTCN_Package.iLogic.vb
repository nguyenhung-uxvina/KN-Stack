...
'     python scripts/extract/bom_xlsx_to_seed.py --bom <asm>_BOM.csv --assembly-code <mã> --product-name "<tên>"
...
Sub Main()
    ...
    Log.AppendLine("  python scripts/extract/bom_xlsx_to_seed.py --bom """ & asmName & "_BOM.csv""")
